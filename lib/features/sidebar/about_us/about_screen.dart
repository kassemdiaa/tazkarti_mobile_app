          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Icon(Icons.arrow_right_rounded),
                  Expanded(child: Text('Original and legitimate tickets not subject to forgery.',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w300),overflow: TextOverflow.clip,)),
              ...
              Row(
                ...
                children: [
                  Icon(Icons.arrow_right_rounded),
                  Text('Latest technologies in booking tickets.',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w300),),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
